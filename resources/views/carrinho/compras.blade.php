            ...
            <div class="divider"></div>
                <div class="row col s12 m12 l12">
                    ...
                    @forelse($compras as $pedido)
                        <h5 class="col l6l s12 m6">Pedido: {{ $pedido->id }}</h5>
                        ...
                        <form method="POST" action="{{ route('carrinho.cancelar') }}">
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    @foreach($pedido->pedido_produtos_itens as $pedido_produto)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img width="100" height="100" src="{{ $pedido_produto->produto->imagem}}" alt="Imagem do produto {{$pedido_produto->produto->id}}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                R$ {{ number_format($pedido_produto->desconto, 2, ',', '.') }}
                                            </td>
                                            <td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td>
                                            <button type="submit" class="btn-large red col l12 s12 m12 tooltipped" data-position="bottom" data-delay="50" data-tooltip="Cancelar itens selecionados">Cancelar</button>
                                        </td>
                                        <td></td>
                                    </tr>
                                </tfoot>
                        ...
                        @empty
                            <h5 class="center">
                                ...
                                @else
                                    Você ainda não fez nenhuma collator_compra
                                @endif
                            </h5>
                        @endforelse
                    </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    @php
                                        $total_pedido = 0;
                                    @endphp
                                    @foreach($pedido->pedido_produtos->itens as $pedido_produto)
                                        @php
                                            $total_produto = $pedido_produto->valor - $pedido_produto->desconto;
                                            $total_pedido += $total_produto;
                                        @endphp
